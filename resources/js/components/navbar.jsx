...
export default function Navbar() {
  ...
  // ✅ per-page navbar background
  const isServicesPage = location.pathname === "/services";
  const headerBgClass = isServicesPage ? "bg-[#dcdcdc]" : "bg-transparent";

  return (
    <>
      {/* HEADER (not sticky) */}
      <header className={`w-full z-20 ${headerBgClass}`}>
      ...
      {open && (
        <div
          className="fixed inset-0 z-50 bg-[#e6e6e6] [font-family:var(--font-neue)]"
        ...
        >
          <div onClick={(e) => e.stopPropagation()}>
            ...
            <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
              ...
              {/* Right: RMTY */}
              <div className="text-xl md:text-2xl tracking-wide font-medium text-black">
                RMTY
              </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 pb-10 h-[calc(100vh-84px)] flex items-center">
              <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-10 items-center">
                {/* Left: Address + Phone */}
                <div className="text-base font-normal text-gray-600 space-y-6 self-start pt-16 md:pt-28">
                  ...
                  <div className="flex items-center gap-5 text-black">
                    {/* Facebook */}
                    <a href="https://www.facebook.com/rmtyarchitects" aria-label="Facebook" className="hover:opacity-70 transition">
                    ...
                    {/* Instagram */}
                    <a href="https://www.instagram.com/rmty_architecture/" aria-label="Instagram" className="hover:opacity-70 transition">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">

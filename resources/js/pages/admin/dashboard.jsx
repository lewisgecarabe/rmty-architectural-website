      ...
      <div className="flex">
        ...
        <div className="flex-1">
          ...
          <main className="min-h-[calc(100vh-72px)] bg-[#f3f3f3] p-6">
            <div className="h-[72vh] rounded-md border border-transparent" />
          </main>
        </div>
      </div>
    </div>
...
function AdminSidebar() {
  ...
  // auto-open dropdown if you're inside content routes
  React.useEffect(() => {
      ...
      <div className="px-5 py-5">
        ...
        <nav className="space-y-1">
          ...
          <button
            ...
            onClick={() => {
              // Hook to your real logout endpoint later
              alert("Secure Logout clicked");
            }}
          >
            <span className="inline-flex items-center gap-3">
              <GridIcon />

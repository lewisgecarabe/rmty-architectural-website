...
export default function Home() {
  // 1. Add State for the featured projects
  const [featuredProjects, setFeaturedProjects] = useState([]);

  // 2. Add useEffect to fetch the data when the Home page loads
  useEffect(() => {
    const fetchFeaturedProjects = async () => {
      try {
        ...
        // Grab only the first 3 projects for the Home page grid
    ...
    <>
      ...
      <section className="relative w-full h-screen bg-black overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <img src="./images/home-hero.webp" alt="home-hero" className="w-full h-full object-cover"/>
        ...
        <div className="max-w-screen-2xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
            {featuredProjects.map((project) => (
              <div key={project.id || project.slug} className={project.colSpan || 'col-span-1'}>
                <ProjectCard 
                  title={project.title}
                  category={project.category?.name || project.location}
          ...
          <div className="flex flex-col items-start justify-center h-full">
            ...
            <div className="space-y-8 w-full max-w-md">
              <div>
                ...
                <a href="mailto:rmty.architects@gmail.com" className="text-lg md:text-xl font-medium hover:text-gray-300 transition-colors">
                  rmty.architects@gmail.com
                </a>
              </div>
              <div>
                <p className="text-gray-500 text-sm mb-1">Phone</p>
                <p className="text-lg md:text-xl font-medium">0915 896 2275</p>
              </div>
              <div>
                <p className="text-gray-500 text-sm mb-1">Address</p>
                <p className="text-lg md:text-xl font-medium leading-relaxed">
                  911 Josefina 2 Sampaloc, Manila,<br/>Philippines
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="w-full aspect-[4/3] md:aspect-[16/10] overflow-hidden">
               <div className="relative w-full h-full group">
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <img src="./images/home-contact-us.webp" alt="Contact Image" className="w-full h-full object-cover grayscale" />
                  </div>
               </div>
            </div>
            <div>
